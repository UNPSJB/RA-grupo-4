...
(1, 'Programación I', 2, 'SIS101', 1, 1, 1, 0, 1),
(2, 'Programación II', 2, 'SIS201', 1, 2, 1, 0, 1),
(3, 'Bases de Datos', 2, 'SIS301', 1, 1, 1, 0, 1),
(4, 'Ingeniería de Software', 2, 'SIS401', 1, 1, 1, 0, 1),
(5, 'Redes de Computadoras', 2, 'SIS501', 1, 5, 1, 0, 1),

(6, 'Cálculo I', 2, 'MAT101', 2, 6, 2, 0, 1),
(7, 'Álgebra Lineal', 2, 'MAT201', 2, 7, 2, 0, 1),
(8, 'Probabilidad y Estadística', 2, 'MAT301', 2, 8, 2, 0, 1),

(9, 'Contabilidad I', 2, 'ECO101', 3, 9, 3, 0, 1),
(10, 'Economía General', 2, 'ECO201', 3, 10, 3, 0, 1),
(11, 'Auditoría', 2, 'ECO401', 3, 4, 3, 0, 1),

(12, 'Biología General', 2, 'BIO101', 4, 2, 4, 0, 1),
(13, 'Ecología', 2, 'BIO201', 4, 3, 4, 0, 1),

(14, 'Química General', 2, 'QUI101', 5, 4, 5, 0, 1),
(15, 'Operaciones Unitarias', 2, 'QUI301', 5, 5, 5, 0, 1);
